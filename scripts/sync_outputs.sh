...
echo ""
echo "=== Session 2 — Cases + Serial Actor + Report v3 + Pipeline v2 ==="
copy_file "cases.py"               "src/api/cases.py"
...
copy_file "report_generator_v3.py" "src/investigation/report_generator.py"
copy_file "pipeline_v2.py"         "src/investigation/pipeline.py"
copy_file "e2e_test.py"            "scripts/e2e_test.py"
...
overwrite_file "main.py" "src/api/main.py"
...
copy_file "peeling_chain.py"     "src/investigation/peeling_chain.py"
copy_file "adapter.py"           "src/investigation/adapter.py"
copy_file "freeze_request.py"    "src/investigation/freeze_request.py"
copy_file "visualizer.py"        "src/investigation/visualizer.py"
copy_file "cio_cluster.py"       "src/investigation/cio_cluster.py"
copy_file "bulk_ingest.py"       "src/investigation/bulk_ingest.py"
copy_file "auth.py"              "src/api/auth.py"
