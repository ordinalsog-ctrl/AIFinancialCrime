...
echo ""
echo "=== Session 2 — Attribution + Bulk + Auth ==="
cp_file "attribution_ingesters.py"      "src/investigation/attribution_ingesters.py"
cp_file "attribution_ingesters_bulk.py" "src/investigation/attribution_ingesters_bulk.py"
cp_file "run_bulk_attribution_import.py" "scripts/run_bulk_attribution_import.py"
...
cp_file "run_attribution_ingest.sh" "scripts/run_attribution_ingest.sh"
